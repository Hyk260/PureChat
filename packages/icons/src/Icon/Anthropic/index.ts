...
const Combine = createCombineComponent("AnthropicCombine", Mono, Text, COMBINE_TEXT_MULTIPLE, TITLE)

export default createIcon(Mono, Text, Combine, Avatar, { colorPrimary: COLOR_PRIMARY }, TITLE)
