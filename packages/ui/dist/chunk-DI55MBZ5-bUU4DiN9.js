import { g as te } from "./chunk-55IACEB6-BX0-IV8n.js";
import { s as ee } from "./chunk-QN33PNHL-DbBsnF1A.js";
import { _ as f, l as b, c as F, r as se, u as ie, a as re, b as ae, g as ne, s as oe, q as le, t as ce, ab as he, k as z, z as ue } from "./mermaid.core-CmI31nLO.js";
var vt = function() {
  var e = /* @__PURE__ */ f(function(V, o, h, n) {
    ...
    parse: /* @__PURE__ */ f(function(o) {
      var h = this, n = [0], g = [], E = [null], r = [], Z = this.table, c = "", U = 0, X = 0, ut = 2, tt = 1, Tt = r.slice.call(arguments, 1), D = Object.create(this.lexer), j = { yy: {} };
      ...
      function Lt() {
        var O;
        return O = g.pop() || D.lex() || tt, typeof O != "number" && (O instanceof Array && (g = O, O = g.pop()), O = h.symbols_[O] || O), O;
      }
      f(Lt, "lex");
      for (var C, H, w, mt, J = {}, dt, Y, Ot, ft; ; ) {
        if (H = n[n.length - 1], this.defaultActions[H] ? w = this.defaultActions[H] : ((C === null || typeof C > "u") && (C = Lt()), w = Z[H] && Z[H][C]), typeof w > "u" || !w.length || !w[0]) {
          ...
          D.showPosition ? bt = "Parse error on line " + (U + 1) + `:
` + D.showPosition() + `
Expecting ` + ft.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : bt = "Parse error on line " + (U + 1) + ": Unexpected " + (C == tt ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(bt, {
            text: D.match,
        ...
        switch (w[0]) {
          case 1:
            n.push(C), E.push(D.yytext), r.push(D.yylloc), n.push(w[1]), C = null, X = D.yyleng, c = D.yytext, U = D.yylineno, _t = D.yylloc;
            break;
          case 2:
...
var st = /* @__PURE__ */ f((e, t, s, a, i, l, d, S) => {
  ...
  if (b.info("dataFetcher parsedItem", t, T, m), p !== "root") {
    ...
    if (L.shape === It && (L.label = ""), e && e.id !== "root" && (b.trace("Setting node ", p, " to be child of its parent ", e.id), L.parentId = e.id), L.centerLabel = !0, t.note) {
      const I = {
        labelStyle: "",
        shape: Te,
        label: t.note.text,
  ...
  addState(t, s = it, a = void 0, i = void 0, l = void 0, d = void 0, S = void 0, p = void 0) {
    ...
    if (!this.currentDocument.states.has(T))
      b.info("Adding state ", T, i), this.currentDocument.states.set(T, {
        stmt: Q,
        id: T,
        descriptions: [],
        type: s,
    ...
    if (i && (b.info("Setting state description", T, i), (Array.isArray(i) ? i : [i]).forEach((m) => this.addDescription(T, m.trim()))), l) {
      const _ = this.currentDocument.states.get(T);
      if (!_)
        throw new Error(`State not found: ${T}`);
      _.note = l, _.note.text = z.sanitizeText(_.note.text, F());
    }
    d && (b.info("Setting state classes", T, d), (Array.isArray(d) ? d : [d]).forEach((m) => this.setCssClass(T, m.trim()))), S && (b.info("Setting state styles", T, S), (Array.isArray(S) ? S : [S]).forEach((m) => this.setStyle(T, m.trim()))), p && (b.info("Setting state styles", T, S), (Array.isArray(p) ? p : [p]).forEach((m) => this.setTextStyle(T, m.trim())));
  }
  clear(t) {
