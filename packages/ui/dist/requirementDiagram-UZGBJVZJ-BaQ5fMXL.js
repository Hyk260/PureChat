import { g as ze } from "./chunk-55IACEB6-BX0-IV8n.js";
import { s as Ge } from "./chunk-QN33PNHL-DbBsnF1A.js";
import { _ as f, b as Xe, a as Je, s as Ze, g as et, q as tt, t as st, c as Ne, l as qe, z as it, D as rt, p as nt, r as at, u as lt } from "./mermaid.core-CmI31nLO.js";
var Ae = function() {
  var e = /* @__PURE__ */ f(function(P, i, r, l) {
    ...
    parse: /* @__PURE__ */ f(function(i) {
      var r = this, l = [0], s = [], d = [null], t = [], Ee = this.table, n = "", ye = 0, Pe = 0, He = 2, $e = 1, Ke = t.slice.call(arguments, 1), S = Object.create(this.lexer), z = { yy: {} };
      ...
      for (var b, G, q, Te, J = {}, ge, F, Ye, _e; ; ) {
        if (G = l[l.length - 1], this.defaultActions[G] ? q = this.defaultActions[G] : ((b === null || typeof b > "u") && (b = Ue()), q = Ee[G] && Ee[G][b]), typeof q > "u" || !q.length || !q[0]) {
          var ke = "";
          _e = [];
          for (ge in Ee[G])
