import { _ as s, c as xt, l as E, d as q, ac as kt, ad as vt, ae as _t, af as bt, D as wt, ag as St, z as Et } from "./mermaid.core-CmI31nLO.js";
import { d as nt } from "./arc-Dgpf36f9.js";
var X = function() {
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + (M + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (I[0]) {
          case 1:
            ...
            break;
          case 2:
            if (P = this.productions_[I[1]][1], F.$ = y[y.length - P], F._$ = {
              ...
              return K;
            P && (h = h.slice(0, -1 * P * 2), y = y.slice(0, -1 * P), o = o.slice(0, -1 * P)), h.push(this.productions_[I[1]][0]), y.push(F.$), o.push(F._$), et = S[h[h.length - 2]][h[h.length - 1]], h.push(et);
            break;
          case 3:
            return !0;
        }
...
var zt = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), f && f.length > 0 ? f.forEach((L) => {
    ...
    E.debug("sectionNode", $);
    const R = p.append("g"), A = z.drawNode(R, $, S, i);
  ...
  for (const f of t) {
    ...
    E.debug("taskNode", r);
    const a = n.append("g").attr("class", "taskWrapper"), u = z.drawNode(a, r, e, c).height;
  ...
  for (const m of t) {
    ...
    E.debug("eventNode", p);
    const x = n.append("g").attr("class", "eventWrapper"), f = z.drawNode(x, p, e, d).height;
