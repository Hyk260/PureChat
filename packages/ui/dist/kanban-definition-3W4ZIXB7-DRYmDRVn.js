import { _ as c, l as te, c as W, K as fe, ah as ye, ai as be, aj as me, ac as _e, H as Y, i as G, v as Ee, J as ke, ad as Se, ae as le, af as ce } from "./mermaid.core-CmI31nLO.js";
import { g as Ne } from "./chunk-FMBD7UC4-C5wmV1Uv.js";
var $ = function() {
  var t = /* @__PURE__ */ c(function(_, s, n, a) {
    for (n = n || {}, a = _.length; a--; n[_[a]] = s) ;
    return n;
  }, "o"), g = [1, 4], d = [1, 13], r = [1, 12], p = [1, 15], E = [1, 16], f = [1, 20], h = [1, 19], L = [6, 7, 8], C = [1, 26], w = [1, 24], N = [1, 25], i = [6, 7, 11], j = [1, 31], x = [6, 7, 11, 24], P = [1, 6, 13, 16, 17, 20, 23], H = [1, 35], M = [1, 36], A = [1, 6, 7, 11, 13, 16, 17, 20, 23], U = [1, 38], V = {
...
` + b.showPosition() + `
Expecting ` + X.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Z = "Parse error on line " + (z + 1) + ": Unexpected " + (k == re ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Z, {
            text: b.match,
...
` + t);
  ...
  for (const m of w) {
    ...
    x = Math.max(x, (M = _ == null ? void 0 : _.labelBBox) == null ? void 0 : M.height), j.push(_);
  }
  let P = 0;
  for (const m of w) {
    const O = j[P];
  ...
  _e(
    void 0,
    h,
    ((U = f.mindmap) == null ? void 0 : U.padding) ?? Y.kanban.padding,
