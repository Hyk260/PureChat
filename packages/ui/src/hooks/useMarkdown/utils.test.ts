...
describe("transformCitations", () => {
  it("should transform citation references to markdown links", () => {
    ...
    const expected = "This is a reference [#citation-1](citation-1) and another [#citation-2](citation-2)."
  ...
  it("should handle multiple consecutive citations", () => {
    ...
    const expected = "Multiple citations [#citation-1](citation-1)[#citation-2](citation-2)[#citation-3](citation-3)."
  ...
  it("should not transform citations beyond the specified length", () => {
    ...
    const expected = "References [#citation-1](citation-1), [#citation-2](citation-2), [3], and [4]."
    expect(transformCitations(content, 2)).toBe(expected)
  })
