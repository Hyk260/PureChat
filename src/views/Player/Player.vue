<template>
  <div class="player" @click="toggleLyrics">
    ...
    <div
      class="progress-bar"
      :class="{ nyancat: settings.nyancatStyle, 'nyancat-stop': settings.nyancatStyle && !player.playing }"
      @click.stop
    >
      <!-- 进度条 -->
      <vue-slider
    ...
    <div class="controls">
      ...
      <div class="playing">
        <div class="container" @click.stop>
          <img :src="currentTrack.al && currentTrack.al.picUrl | resizeImage(224)" @click="goToAlbum" />
      ...
      <div class="middle-control-buttons">
        ...
        <div class="container" @click.stop>
          ...
          <!-- FM 模式 不喜欢 -->
          <button-icon v-show="player.isPersonalFM" title="不喜欢" @click.native="player.moveToFMTrash()">
      ...
      <div class="right-control-buttons">
        ...
        <div class="container" @click.stop>
          ...
          <button-icon
            ...
            :class="{ active: $route.name === 'next', disabled: player.isPersonalFM }"
          ...
          <button-icon
            v-show="!player.isPersonalFM"
            :class="{ active: player.repeatMode !== 'off', disabled: player.isPersonalFM }"
          ...
          <!-- 歌词 -->
          <button-icon class="lyrics-button" title="歌词" @click.native="toggleLyrics()" style="margin-left: 12px">
...
//       this.$route.name === 'next' ? this.$router.go(-1) : this.$router.push({ name: 'next' })
//     },
//     // 解析进度条时间
